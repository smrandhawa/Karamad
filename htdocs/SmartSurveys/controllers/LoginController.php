...
class LoginController extends Controller
{
    ...
    {
        if (isset($_GET['statusMessage']) && (!empty($_GET['statusMessage'])))
        {
            if($_GET['statusMessage'] == 'PS')
            {
                $this->assign('statusMessage', 'Password updated successfully');
            }
        }
     ...
     */
    protected function createUserSession(Requester $login)
    {
        $this->startSession();
     ...
     */
    protected function authenticateLogin(Requester $login, $password)
    {
