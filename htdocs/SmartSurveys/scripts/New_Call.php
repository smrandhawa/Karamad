...
{
	$query = "INSERT INTO  ".$GLOBALS['DB'].".`call table` (`Call_ID`,`Originating _Request_ID`,`Phone_Number`,`Call_Type`,`Call_Start_Time`,`Call_End_Time`,`CallStatus`, `Channel`, `Attempt_Start_Time`) VALUES ('0',  '$reqid', '$phno', '$calltype', NOW(), NOW(), '$status', '$channel', NOW());";
