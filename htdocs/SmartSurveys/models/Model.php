...
abstract class Model
{
    ...
    /**
     * Query the database for a given SQL query 
     *
     * @param PDO $pdo the database to search in
     * @param string $sql the SQL query to execute
     * @return array returns an associated array of the results
     */
    public static function querySqlandReturnArrayResult(PDO $pdo, $sql)
    {
        $stmt = $pdo->prepare($sql);
        $stmt->execute();
