...
--this_sess:consoleLog("info", "*******function: askgather.lua*******: ".. "\n");
...
--this_sess:consoleLog("info", "timeout: " .. timeout .. "\n");
--this_sess:consoleLog("info", "timeout_prompt: " .. timeout_prompt .. "\n");
--this_sess:consoleLog("info", "digit_timeout: " .. digit_timeout .. "\n");
...
--			this_sess:consoleLog("info", "max_digits1: " .. max_digits .. "\n");
			...
			if digits ~= "" then
				--this_sess:consoleLog("info", "input_received_not_valid: " .. digits .. "\n")
				if isvalid(digits,valid_input_mx_1) == true then
					--this_sess:consoleLog("info", "input_received: " .. digits .. "\n")
...
--	this_sess:consoleLog("info", "max_attempts2: " .. max_attempts .. "\n");
	if tonumber(max_digits) < 2 then
		...
		stream:write("_"..digits);
		--this_sess:consoleLog("info", "number entered: " .. valid_input .. "\n");
	end
end
